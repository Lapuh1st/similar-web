...
module.exports = function ( karma ) {
  ...
  karma.set({
    ...
    files: [
        ...
        'src/app/similar/similar.js',
        'src/app/similar/similar-controller.js',
        'src/app/similar/data-factory.js',
        'src/app/app.js',
        '.tmp/ciklum-templates.js',
        'src/app/similar/similar-controller_test.js'
      ],
